...
LocomotiveScrollTrigger();
 ...
 /* DTT - Digital Twin Token */
var clutter ="";

document.querySelector("#DTT-page>h2").textContent.split(" ").forEach( function (details) {
    clutter += `<span> ${details} </span>`;

    document.querySelector("#DTT-page>h2").innerHTML = clutter;
});

gsap.to("#DTT-page>h2>span", {
    scrollTrigger:{
        trigger: "#DTT-page>h2>span",
        start: "top bottom",
        end: "bottom top",
        scroller: "#main",
        scrub: .5,
...
document.querySelector("#stakeholder-page>h2").textContent.split("").forEach(function (details) {
    clutter += `<span>${details}</span>`;

    document.querySelector("#stakeholder-page>h2").innerHTML = clutter;
});

gsap.to("#stakeholder-page>h2>span" ,{
    scrollTrigger:{
        trigger: "#stakeholder-page>h2>span",
        start: "top bottom",
        end: "bottom top",
        scroller: `#main`,
        // markers: true,
...
document.querySelector("#page6>h2").textContent.split("").forEach( function (details) {
    clutter += `<span>${details}</span>`;
...
gsap.to("#page8-circle", {
    scrollTrigger: {
        trigger: "#page8-circle",
        start: "top center",
        end: "bottom top",
        // markers: true,
        scroller: "#main",
...
gsap.to("#page8-innerCircle", {
    scrollTrigger: {
        trigger: "#page8-innerCircle",
        start: "top center",
        end: "bottom top",
        // markers: true,
        scroller: "#main",
